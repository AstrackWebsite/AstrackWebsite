    ...
    <Document title={`Closeout — ${p.reference}`}>
      <Page size="A4" style={s.page}>
        <View style={s.brandRow}>
          <Text style={s.brand}>ART Asbestos</Text>
        ...
        <Text style={s.footer} fixed>
          ART Asbestos · Compliance record retained under CAR 2012 Reg 19 · This
          pack is an auditable snapshot generated at closeout.
        </Text>
      </Page>
    </Document>
  );
