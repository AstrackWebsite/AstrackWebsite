...
export function CloseoutPack({ data }: { data: CloseoutData }) {
  ...
  return (
    <Document title={`Closeout — ${p.reference}`}>
      <Page size="A4" style={s.page}>
        <View style={s.brandRow}>
          <Text style={s.brand}>AsTrack</Text>
          <Text style={s.docTitle}>Project Closeout Pack</Text>
        </View>
        ...
        <Text style={s.footer} fixed>
          Generated by AsTrack · Compliance record retained under CAR 2012 Reg 19
          · This pack is an auditable snapshot generated at closeout.
        </Text>
      </Page>
    </Document>
  );
